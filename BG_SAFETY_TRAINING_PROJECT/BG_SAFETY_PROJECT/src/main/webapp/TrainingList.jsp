...
<body>
    ...
    <% if ("admin".equals(role)) { %>
        <a href="training-form.jsp">➕ Add Training</a><br><br>
    <% } %>
    ...
    <table border="1" cellpadding="10">
        ...
        <% if (trainings != null && !trainings.isEmpty()) {
            ...
            <tr>
                ...
                <% if ("admin".equals(role)) { %>
                    <td>
                        <a href="training?action=edit&id=<%= t.getId() %>">Edit</a> |
                        <a href="training?action=delete&id=<%= t.getId() %>" 
                           onclick="return confirm('Delete this training?');">Delete</a>
                    </td>
                <% } %>
            </tr>
        <%   } 
           } else { %>
            <tr><td colspan="4">No trainings found.</td></tr>
        <% } %>
    </table>
