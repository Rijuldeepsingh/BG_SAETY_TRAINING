...
<body>
    ...
    <p>If you can see this page, it means that your project is deployed correctly and the context path is correct. The problem is likely with your servlets or their configuration.</p>
